...
class Helper(Singleton):
    def __init__(self) -> None:
        if not super().created:
            ...
            self.HELP_PLAY = 'Plays a song from URL or name.'
            ...
            self.HELP_PLAY_LONG = 'Play a song in discord. \n\nRequire: You to be connected to a voice channel.\nArguments: Youtube, Spotify song/playlist link or the title of the song to be searched in Youtube.'
            ...
            self.HELP_CHOOSE_LONG = 'Choose randomly one item passed in this command.\n\nRequire: Items to be separated by comma.\nArguments: As much as you want.'
            self.HELP_FAC = 'Return heads or tails.'
            self.HELP_FAC_LONG = 'Return heads or tails.'
